...
doi: "10.1007/s10928-026-10028-9"
paper_type: popk
tags: [popk, pbpk]
...
![Conceptual schematic of the maternal–placental–fetal PBPK model. The left panel shows substance exchange between the fetus and amniotic fluid, while the right panel presents an ove]({{ site.baseurl }}/assets/digests/2026-03-30-utility-of-a-physiologically-based-pharmacokinetic-model-to-elucidate-the/figures/fig_01.jpg)

![(a) Heat map of simulated F/M (AUC ratio over one dosing interval at steady state) as a function of placental P-gp activity and passive permeability (Papp scaling factor). (b) Mate]({{ site.baseurl }}/assets/digests/2026-03-30-utility-of-a-physiologically-based-pharmacokinetic-model-to-elucidate-the/figures/fig_02.jpg)

![(a,b) Plasma concentration–time profiles of digoxin following a single oral dose in pregnant (a) and postpartum (b) women. Simulated profiles are shown, with observed data (mean ± ]({{ site.baseurl }}/assets/digests/2026-03-30-utility-of-a-physiologically-based-pharmacokinetic-model-to-elucidate-the/figures/fig_03.jpg)

![Simulated concentration–time profiles based on a clinically reported dosing regimen are shown in maternal plasma (a) and the umbilical vein (b) 19]({{ site.baseurl }}/assets/digests/2026-03-30-utility-of-a-physiologically-based-pharmacokinetic-model-to-elucidate-the/figures/fig_04.jpg)

![Simulated time course of instantaneous F/M (fetal-to-maternal concentration ratio) under the clinically reported dosing regimen 19]({{ site.baseurl }}/assets/digests/2026-03-30-utility-of-a-physiologically-based-pharmacokinetic-model-to-elucidate-the/figures/fig_05.jpg)