...
![FIGURE 1: Workflow for determining recommended dosage regimens. Orange arrows represent the proposed workflow (SCOUT), while blue arrows indicate the conventional typical]({{ site.baseurl }}/assets/digests/2026-04-02-scout-an-exploratory-approach-to-scouting-dose-relevant-covariates/figures/fig_01.jpg)

![FIGURE 2: Scatter plots of estimated optimal doses versus patient characteristics from Part 1, Scenario 1 (A) and Scenario 2 (B). The blue lines represent smooth lines wit]({{ site.baseurl }}/assets/digests/2026-04-02-scout-an-exploratory-approach-to-scouting-dose-relevant-covariates/figures/fig_02.jpg)

![FIGURE 3: Scatter plots and box-and-whisker plots of estimated optimal doses versus patient characteristics from Part 2. The blue lines represent smooth lines with loess.]({{ site.baseurl }}/assets/digests/2026-04-02-scout-an-exploratory-approach-to-scouting-dose-relevant-covariates/figures/fig_03.jpg)

![FIGURE 4: Scatter plots of estimated optimal doses versus patient characteristics from Part 3: A 2-week-on, 1-week-off regimen (A) and an EOW regimen (B). The blue lines r]({{ site.baseurl }}/assets/digests/2026-04-02-scout-an-exploratory-approach-to-scouting-dose-relevant-covariates/figures/fig_04.jpg)