...
![FIGURE 1: Flow diagram of the methodology used for repository building from CAR-T cell submissions. Flow diagram summarizing the retrospective process used to build the re]({{ site.baseurl }}/assets/digests/2026-03-27-modeling-and-simulation-in-development-and-regulatory-approval-of-chimeric/figures/fig_01.jpg)

![FIGURE 2: General structure of the repository harmonized from different use-cases. Framework illustrating how benefit–risk assessment is supported by the characterization]({{ site.baseurl }}/assets/digests/2026-03-27-modeling-and-simulation-in-development-and-regulatory-approval-of-chimeric/figures/fig_02.jpg)

![FIGURE 3: Comparison of number of studies across approved CAR-T cells. Overview of the non-clinical and clinical studies that support marketing authorizations and line ext]({{ site.baseurl }}/assets/digests/2026-03-27-modeling-and-simulation-in-development-and-regulatory-approval-of-chimeric/figures/fig_03.jpg)

![FIGURE 4: Overview of the repository of key regulatory and methodology questions. Distribution of regulatory questions extracted from CAR-T cell submissions is presented i]({{ site.baseurl }}/assets/digests/2026-03-27-modeling-and-simulation-in-development-and-regulatory-approval-of-chimeric/figures/fig_04.jpg)

![FIGURE 5: Use of M&S methods across drug development of CAR-T cells on the market. Temporal overview of the use of modeling and simulation (M&S) across CAR-T cell developm]({{ site.baseurl }}/assets/digests/2026-03-27-modeling-and-simulation-in-development-and-regulatory-approval-of-chimeric/figures/fig_05.jpg)

![FIGURE 6: Example of method benchmarking including credibility assessment through the ICH M15 table for assessment of MIDD evidence. Example of application of a credibilit]({{ site.baseurl }}/assets/digests/2026-03-27-modeling-and-simulation-in-development-and-regulatory-approval-of-chimeric/figures/fig_06.jpg)