...
## Paper 1: Utilization of Model-Informed Drug Development in Early Clinical Development: Ca
...
- **DOI**: [https://doi.org/10.1002/psp4.70238](https://doi.org/10.1002/psp4.70238)
...
#figure(
  ...
  caption: [FIGURE 1: An overview of the MIDD strategy, including the criteria to proceed to next phase. Planned analysis shaded blue represents assessment for criterion 1; planned an],
) <fig-1>
...
#figure(
  ...
  caption: [FIGURE 2: PKPD Model Schematics. (A) Schematics of Pharmacokinetics model (B) Schematics of semi-mechanistic RBC model incorporating feedback between PK and target changes],
) <fig-2>
#set page(flipped: false)
```
...
#figure(
  ...
  caption: [FIGURE 3: Hb simulations and p20 projections. Model projected Hb coverage of healthy population (A) and SCD population (B) for doses ranging from 1250 mg BID to 2500 mg BI],
) <fig-3>
#set page(flipped: false)
```
...
#figure(
  ...
  caption: [FIGURE 4: Virtual population simulations for projecting Hb changes in SCD patients. (A) Relationship of RBC lifetime to Hb coverage. For each virtual patient, the baseline],
) <fig-4>
#set page(flipped: false)
```