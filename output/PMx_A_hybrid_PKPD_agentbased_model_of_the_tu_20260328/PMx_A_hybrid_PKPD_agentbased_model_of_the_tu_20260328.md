...
# PMx Weekly Digest: March 28, 2026

## Paper 1: A hybrid PKPD agent-based model of the human tunour microenvironment
...
- **DOI**: [https://doi.org/10.1007/s10928-026-10021-2](https://doi.org/10.1007/s10928-026-10021-2)
...
#figure(
  ...
  caption: [Schematic representation of the ABM. There are three types of agents: cancer cells, immune effector cells and immune suppressor cells. The attributes and actions of each type are s],
) <fig-1>
...
#figure(
  ...
  caption: [Figures 2a–f show the interaction of tumour and immune cells over time],
) <fig-2>
#set page(flipped: false)
```
...
#figure(
  ...
  caption: [Figures 3a – d show the interaction of the cancer cells with the immune system over time and at the end of the simulation. Figure 3: e shows the cell count over time. A movie can b],
) <fig-3>
#set page(flipped: false)
```
...
#figure(
  ...
  caption: [Figures 4a – f show the PKPD of a PD1 antibody treatment and the interaction of tumour and immune cells over time with different treatment schedules],
) <fig-4>
#set page(flipped: false)
```
...
#figure(
  ...
  caption: [Figures 5a – d show the effect of radiotherapy with a weekly dose of 2.5 Gy/day for 5 days/week for 6 weeks starting at day 50 and day 100],
) <fig-5>
#set page(flipped: false)
```
...
#figure(
  ...
  caption: [Figures 6a – f show the chemotherapy treatment with 0.132g docetaxel Q3W with the resulting drug concentration, kill rate, cell count and cell cycle phases],
) <fig-6>
#set page(flipped: false)
```
...
#figure(
  ...
  caption: [Figures 7a –8d show the DNA damage response inhibitor treatment with weekly 210with the resulting pharmacokinetic and pharmacodynamic, cell count, rates of cell interaction, and th],
) <fig-7>
#set page(flipped: false)
```
...
#figure(
  ...
  caption: [Figures7a – 8d show the DNA damage response inhibitor treatment with weekly 210with the resulting pharmacokinetic and pharmacodynamic, cell count, rates of cell interaction, and th],
) <fig-8>
#set page(flipped: false)
```
...
#figure(
  ...
  caption: [Figures 9a – f show different options for combination treatment and their impact on the cell count and cell interaction rates over time],
) <fig-9>
#set page(flipped: false)
```