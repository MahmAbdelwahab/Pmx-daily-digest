...
# PMx Weekly Digest: April 03, 2026

## Paper 1: Follow-Up Bias in Tumor Dynamic Modeling: A Comparison of Classical and Neural-O
...
- **DOI**: [https://doi.org/10.1002/psp4.70239](https://doi.org/10.1002/psp4.70239)
...
#figure(
  ...
  caption: [FIGURE 1: Schematic of the workflow in the comparison of Classical TGI models and TDNODE for tumor dynamic prediction. (A) Taking data from a clinical trial and based on t],
) <fig-1>
#set page(flipped: false)
```
...
#figure(
  ...
  caption: [FIGURE 2: Comparison of Classical TGI models and TDNODE predictions versus observations used in model estimation (goodness-of-fit on ‘seen’ training data) (A); Comparison],
) <fig-2>
#set page(flipped: false)
```
...
#figure(
  ...
  caption: [FIGURE 3: Comparison of Classical TGI models and TDNODE's relative error on seen (A) and unseen (B) clinical data. All models were fitted or trained using available estima],
) <fig-3>
#set page(flipped: false)
```
...
#figure(
  ...
  caption: [FIGURE 4: Comparison of the observed versus predicted SLD between Claret TGI model (A) and TNDODE (B) across the subset of patients who had a partial response (PR) with no],
) <fig-4>
#set page(flipped: false)
```
...
#figure(
  ...
  caption: [FIGURE 5: Relationship between extrapolation error and parameter estimate error for the Stein model across enrollment cuts. Extrapolation error defined as the median relat],
) <fig-5>
#set page(flipped: false)
```