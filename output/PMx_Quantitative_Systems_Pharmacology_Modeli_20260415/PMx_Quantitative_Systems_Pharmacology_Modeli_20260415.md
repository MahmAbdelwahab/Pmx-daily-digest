...
# PMx Weekly Digest: April 15, 2026

## Paper 1: Quantitative Systems Pharmacology Modeling Amid the Rise of Agentic AI
...
- **DOI**: [https://doi.org/10.1002/psp4.70249](https://doi.org/10.1002/psp4.70249)
...
#figure(
  ...
  caption: [FIGURE 1: Agentic AI enhances QSP workflows by automating various modeling, simulation, and analysis tasks (left), while QSP perspective and input provide crucial inputs w],
) <fig-1>
